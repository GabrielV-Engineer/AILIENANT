...
- [ ] **12.10 — Pre-Launch Innovation Gate.** Prompt caching tokens-saved metric > 0; DEBT-049/054/051(already closed)/083(already closed)/084(already closed)/085(already closed)/086(already closed)/045/047/052/067/012/079/097/100/106/129/130/127(conditional)/121/123/124/125/126/128/132/133/134 closed (DEBT-014 closed only if unblocked; DEBT-122 has an explicit logged decision, not necessarily closed; DEBT-138 stays open — blocked on an OCC-safe sync surface, not a 12.x gate item; DEBT-139 is floating, not required for this gate); manifest and backlog ledger rows internally consistent (12.9); `pytest` green · `mypy .` 0 · `npm run compile` 0.
