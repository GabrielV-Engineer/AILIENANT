...
- [ ] **7.19.6 — Frontend: Interactive Chat PTY (xterm.js) + Composer Send/Stop Toggle** — **[ADR-753]**
...
- [ ] **7.19.7 — Structured Agent Output: Execution Checklist & Rich Explanatory Rendering** — **[ADR-754]**
...
- [ ] **7.19.8 — Checkpoint Gate Fase 7.19** — **[ADR-755]**
