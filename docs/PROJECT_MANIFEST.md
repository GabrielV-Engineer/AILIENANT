...
- **Próximo Objetivo:** 7.18.1 — Session-Heatmap Recency (RAG, upgrade #2 del Arquitecto): reemplazar el placeholder `recency_score=0.5` por `0.7·time_decay + 0.3·access_frequency`. (7.18.0 — Closed-Loop Sandboxed Executor — **cerrado 2026-06-04**: el bucle de feedback ya está cableado.) En paralelo siguen disponibles 8.0.0 (mypy --strict) y el track frontend 7.16; el track 7.15 ya está cerrado (prerequisito de 7.14 satisfecho).
...
- [ ] **7.18.1 — Session-Heatmap Recency (RAG · upgrade #2)** — **[ADR-741]**
