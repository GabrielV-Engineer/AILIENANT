...
- **Próximo Objetivo:** 7.18.2 — `response_format` Graceful Degradation (Tool Use): despojar/reparar el param de JSON-mode para backends locales. (7.18.1 — Session-Heatmap Recency — **cerrado 2026-06-04**: el término `0.2·Recency` del CSS ya es señal viva (`0.7·time_decay + 0.3·access_frequency`), no lastre constante. 7.18.0 — Closed-Loop Sandboxed Executor — **cerrado 2026-06-04**.) En paralelo siguen disponibles 8.0.0 (mypy --strict) y el track frontend 7.16; el track 7.15 ya está cerrado (prerequisito de 7.14 satisfecho).
...
- [ ] **7.18.2 — `response_format` Graceful Degradation (Tool Use)** — **[ADR-742]**
...
- [ ] **7.18.3 — AST-Skeleton Code-STYLE Few-Shot (upgrade #3)** — **[ADR-743]**
...
- [ ] **7.18.4 — AST-Hashed Semantic Response Cache (upgrade #4)** — **[ADR-744]**
...
- [ ] **7.18.5 — MCTS-into-Live-Loop: DEFER (fila de decisión)** — **[ADR-745]**
