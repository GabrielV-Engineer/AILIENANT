...
- [ ] **8.5.5 — Eval surface tools** — ⏸️ **BLOQUEADO por 8.3.5** (pausado 2026-06-12)
  ...
  - ⏸️ **Dependencia dura:** no hay productor que consumir hasta que 8.3.5 emita el `report.json` + su schema. Reanuda tras el cierre de División 8.3 (ver el track activo arriba).
