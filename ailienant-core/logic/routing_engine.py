...
class EnvironmentProfile(BaseModel):
    vram_gb: float
    models: Dict[str, LLMProfile] # Roles esperados: "LOCAL_SMALL", "LOCAL_BIG", "CLOUD"
...
class RoutingEngine:
    ...
    def select_best_agent(
        ...
        if css_score < 40.0:
            print("[ALERTA] CSS deficiente. Faltan datos en GraphRAG. Activando Degradación Elegante.")
        ...
        for role, profile in env.models.items():
            ...
            if profile.parameters_b >= min_params:
                ...
                if selected_role == "CLOUD" or profile.parameters_b < env.models[selected_role].parameters_b:
                    selected_role = role
