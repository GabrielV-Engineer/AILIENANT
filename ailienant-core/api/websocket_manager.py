...
class ConnectionManager:
    ...
    async def connect(self, client_id: str, websocket: WebSocket):
        ...
        logger.info(f"🟢 IDE Conectado: {client_id}. Total activos: {len(self.active_connections)}")
    ...
    async def validate_incoming(self, raw_json_string: str) -> Optional[WebSocketMessage]:
        ...
        try:
            ...
            logger.error(f"⚠️ Inyección rechazada en la frontera: Payload malformado. Detalles: {e}")
            return None
