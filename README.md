...
│   │   └── core/               #   IntentRouter, PathResolver, PatchActuator (Phase 7.9.B.18 — VS Code applyEdit actuator + hash stale-guard + save())
